...
export default function PublicHeader() {
  ...
  return <header className="sticky top-0 z-50 border-b border-slate-200/80 bg-white/95 backdrop-blur-xl supports-[backdrop-filter]:bg-white/85">
    <div className="mx-auto flex min-h-[72px] w-full max-w-[var(--marketing-max-w)] items-center gap-3 px-4 sm:px-6 lg:px-8">
      ...
      <Link href="/demarrer-un-projet" className="ml-auto hidden min-h-11 items-center justify-center rounded-full bg-cyan-400 px-5 text-sm font-bold text-slate-950 shadow-[0_14px_32px_rgba(34,211,238,0.22)] transition hover:bg-cyan-300 focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-cyan-200 lg:inline-flex">Démarrer un projet</Link>
